...
//   }
  ...
  onInit() {
    var bgTexture = new THREE.TextureLoader().load("../../images/nslsbg.jpg");
    ...
    this.cont.rotation.x = -0.1159
    this.cont.rotation.z = 0.0
    ...
    const bgeometry = new THREE.PlaneGeometry( 330, 215 );
    const bgmaterial = new THREE.MeshBasicMaterial( {map: bgTexture, side: THREE.DoubleSide, transparent: true, opacity: 0.5} );
    const bgplane = new THREE.Mesh( bgeometry, bgmaterial );
    this.scene.add( bgplane );
    bgplane.position.set(20, 4, -50);
    bgplane.rotation.x = -0.5;
